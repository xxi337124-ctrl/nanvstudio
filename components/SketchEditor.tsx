  ...
  const getCompositeDataURL = (): string => {
    ...
    if (backgroundImage) {
      ...
      const scale = Math.min(
        osc.width / backgroundImage.width,
        osc.height / backgroundImage.height
      );
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#0a0a0c] flex flex-col animate-in fade-in duration-300">
      ...
      <div className="flex-1 relative bg-[#121214] flex items-center justify-center p-8 overflow-hidden">
        ...
        <div className="absolute top-12 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 p-1.5 bg-[#2c2c2e]/90 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl">
          ...
          <div className="relative">
            ...
            >
              <Palette
                size={16}
                style={{ color: tool === 'brush' ? brushColor : undefined }}
              />
              <div
                className="absolute bottom-1 right-1 w-2 h-2 rounded-full border border-[#2c2c2e]"
          ...
          <button
            onClick={handleUndo}
            className="p-2.5 rounded-full text-slate-400 hover:text-white hover:bg-white/5"
          >
            <Undo size={16} />
          </button>
          ...
          <button
            onClick={handleClear}
            className="p-2.5 rounded-full text-red-400 hover:bg-red-500/10"
          >
            <Trash2 size={16} />
          </button>
        </div>
        ...
        {/* The Canvas Wrapper */}
        <div
          className="relative shadow-2xl rounded-lg overflow-hidden border border-white/5 bg-[#ffffff] select-none"
